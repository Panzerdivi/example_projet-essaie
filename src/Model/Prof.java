...
public class Prof {
	 ...
	 public boolean create(){
		 try{
			 PreparedStatement ps= this.c.prepareStatement ("INSERT INTO prof VALUES(NULL,?,?,?,?);");
	 ...
	 public boolean update(){
		 try{
			 PreparedStatement ps=this.c.prepareStatement("UPDATE Prof SET nom=?,age=?,specilate=?,ville=? where idp=?;");
			 ps.setString(1,this.getNom());
			 ps.setInt (2,this.getAge());
			 ps.setString (3,this.getSpecialite());
			 ps.setString(4,this.getVille());
